...
class DisastersControllerTest < ActionController::TestCase
  ...
  test "should create disaster" do
    assert_difference('Disaster.count') do
      post :create, disaster: { country: @disaster.country, date: @disaster.date, description: @disaster.description, name: @disaster.name }
    end
  ...
  test "should update disaster" do
    patch :update, id: @disaster, disaster: { country: @disaster.country, date: @disaster.date, description: @disaster.description, name: @disaster.name }
    assert_redirected_to disaster_path(assigns(:disaster))
  end
